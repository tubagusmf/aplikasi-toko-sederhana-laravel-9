                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info">
                            ...
                            <?php }else{ ?>
                                <strong>Peringatan: </strong>Sudah memiliki akun? Silahkkan <a href="{{ asset('signin') }}">Login di sini</a>
                            <?php } ?>
                        </div>
                        ...
                        <form action="{{ asset('keranjang/proses-checkout') }}" method="post" accept-charset="utf-8">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <?php if(session()->get('username_client') != '') { ?>
                                    <input type="text" class="form-control" name="nama" value="{{ $client->nama_client }}" placeholder="Nama" required>
                                    <?php } else { ?>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <?php if(session()->get('username_client') != '') { ?>
                                        <input type="number" class="form-control" name="telepon" value="{{ $client->telepon }}" placeholder="Telepon" required>
                                    <?php } else { ?>
                                    <input type="number" class="form-control" name="telepon" value="{{ old('telepon') }}" placeholder="Telepon" required>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <?php if(session()->get('username_client') != '') { ?>
                                        <textarea class="form-control" name="alamat" placeholder="Alamat">{{ $client->alamat }}</textarea>
                                    <?php }else{ ?>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <button class="btn btn-success" type="submit">
                                        <i class="fa fa-save"></i> Simpan & Checkout
                                    </button>
                                </div>
                            </div>
                        </form>
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $keranjang->quantity }}
                                    </td>
