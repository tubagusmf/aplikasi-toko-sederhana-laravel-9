          ...
          <div class="row" data-aos="fade-left">
            ...
            <table class="table table-bordered table-sm">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td widht="10%"><img src="{{ asset('assets/upload/image/'.$keranjang['attributes']['image']) }}" class="img-thumbnail"></td>
                            ...
                            <form action="{{ asset('keranjang/update') }}" enctype="multipart/form-data" method="POST" accept-charset="utf-8" class="mb-5">
                                ...
                                <div class="input-group">
                                  ...
                                  <span class="input-group-append">
                                    <button type="submit" class="btn btn-success btn-flat"><i class="fa fa-shopping-cart"></i> Update</button>
                                  </span>
                                </div>
                              </form>
                        </td>
                    ...
                    <tr class="bg-light">
                        ...
                        <td class="text-left">
                            <a href="{{ asset('keranjang/checkout') }}" class="btn btn-warning">
