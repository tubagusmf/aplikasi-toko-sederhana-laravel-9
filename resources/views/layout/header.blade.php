        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Products</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="{{ asset('produk/kategori/'.$nav_produk->slug_kategori) }}">{{ $nav_produk->nama_kategori }}</a></li>
              <?php } ?>
              <li><a href="{{ asset('produk') }}">All Produtcs</a></li>
            </ul>
          </li>
          <li><a class="nav-link scrollto" href="{{ asset('kontak') }}">Contact</a></li>
          <li>
              <a class="nav-link scrollto" href="{{ asset('keranjang') }}">
          ...
          <?php if(session()->get('username_client') != '') { ?>
            <li>
                <a class="nav-link scrollto text-warning" href="{{ asset('dasbor') }}">
                <i class="fa fa-user"></i>&nbsp; {{ session()->get('nama_client') }}
              </a>
            </li>
            <li>
              <a class="nav-link scrollto text-warning" href="{{ asset('signin/logout') }}">
