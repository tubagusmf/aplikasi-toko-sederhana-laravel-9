...
<form action="{{ asset('admin/kategori/proses-edit') }}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
{{ csrf_field() }}
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" class="form-control" name="nama_kategori" value="{{ $kategori->nama_kategori }}" placeholder="Nama">
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <select name="status_kategori" class="form-control">
            <option value="Publish" <?php if($kategori->status_kategori == 'Publish') { echo 'selected'; } ?>>Publish</option>
