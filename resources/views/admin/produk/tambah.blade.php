...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" class="form-control" name="nama_produk" value="{{ old('nama_produk') }}" placeholder="Nama Produk">
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    <label class="col-md-3">Kategori & Merek</label>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        <select name="id_merek" class="form-control select2">
            ...
            <?php foreach($merek as $merek) { ?>
                <option value="<?php echo $merek->id_merek ?>"><?php echo $merek->nama_merek ?></option>
            <?php } ?>
        </select>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <textarea name="deskripsi" class="form-control" placeholder="Deskripsi Ringkas">{{ old('deskripsi') }}</textarea>
    </div>
</div>
<div class="form-group row">
