    ...
    <div class="col-md-3">
        <select name="id_merek" class="form-control select2">
            ...
            <?php foreach($merek as $merek) { ?>
                <option value="<?php echo $merek->id_merek ?>" <?php if($produk->id_merek==$merek->id_merek) { echo 'selected'; }?>><?php echo $merek->nama_merek ?></option>
            <?php } ?>
        </select>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <textarea name="deskripsi" class="form-control" placeholder="Deskripsi Ringkas">{{ $produk->deskripsi }}</textarea>
    </div>
</div>
<div class="form-group row">
