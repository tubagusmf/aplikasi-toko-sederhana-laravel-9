...
<form action="{{ asset('admin/produk/proses') }}" method="post">
    {{ csrf_field() }}
    ...
    <div class="table-responsive mailbox-messages">
        ...
        <div class="input-group input-group-sm">
            ...
            <span class="input-group-append">
              ...
              <a href="{{ asset('admin/produk/unduh') }}" class="btn btn-danger btn-sm" target="_blank"><i class="fa fa-file-pdf"></i> Unduh Pricelist</a>
                <a href="{{ asset('admin/produk/tambah') }}" class="btn btn-success btn-sm">
        ...
        <table class="table table-bordered table-sm" id="example1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ asset('produk/'. $produk->slug_produk) }}" class="btn btn-success btn-sm mb-1" target="_blank"><i class="fa fa-eye"></i></a>

                        <a href="{{ asset('admin/produk/cetak/'. $produk->id_produk) }}" class="btn btn-danger btn-sm mb-1" target="_blank"><i class="fa fa-file-pdf"></i></a>

                        <a href="{{ asset('admin/produk/edit/'. $produk->id_produk) }}" class="btn btn-warning btn-sm mb-1"><i class="fa fa-edit"></i></a>

                        <a href="{{ asset('admin/produk/delete/'. $produk->id_produk) }}" class="btn btn-secondary btn-sm delete-link mb-1"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
                <?php $i++; } ?>
            </tbody>
