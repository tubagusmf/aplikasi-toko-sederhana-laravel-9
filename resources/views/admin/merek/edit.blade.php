...
<form action="{{ asset('admin/merek/proses-edit') }}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
{{ csrf_field() }}
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" class="form-control" name="nama_merek" value="{{ $merek->nama_merek }}" placeholder="Nama">{{ old('keterangan') }}
    </div>
</div>
<div class="form-group row">
