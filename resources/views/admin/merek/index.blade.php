...
<form action="{{ asset('admin/merek/proses') }}" method="post">
    {{ csrf_field() }}
    ...
    <div class="table-responsive mailbox-messages">
        ...
        <div class="input-group input-group-sm">
            ...
            <span class="input-group-append">
              ...
              <a href="{{ asset('admin/merek/tambah') }}" class="btn btn-success btn-sm">
        ...
        <table class="table table-bordered table-sm" id="example1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $merek->urutan }}</td>
                    <td>
                        <a href="{{ asset('admin/merek/edit/'. $merek->id_merek) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                        <a href="{{ asset('admin/merek/delete/'. $merek->id_merek) }}" class="btn btn-secondary btn-sm delete-link"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
                <?php $i++; } ?>
            </tbody>
